...
# upstream   https://github.com/Hotfirenet/ProxmoxVE.git (fetch)
# upstream   https://github.com/Hotfirenet/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/Hotfirenet/ProxmoxVE"
echo ""
